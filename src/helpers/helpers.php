...
if (!function_exists('khofo_path')) {
    function khofo_path($path = '')
    {
        return base_path('vendor/khofaai/khofo/src/' . $path);
    }
}

if (!function_exists(('khofo_modules'))) {
    function khofo_modules()
    {
        return json_decode(file_get_contents(app_path('Khofo') . '/core.json'), true)['modules'];
    }
}

if (!function_exists(('khofo_base'))) {
    function khofo_base($path = '')
    {
        return app_path('Khofo') . '/' . $path;
    }
}

if (!function_exists(('khofo_asset'))) {
    function khofo_asset($path = '')
    {
        return url('app/Khofo') . '/' . $path;
    }
}
